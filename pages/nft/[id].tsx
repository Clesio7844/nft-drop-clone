...
const NFTDropPage = () => {
  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      {/*right */}
      <div className="lg: flex flex-1 flex-col p-12 lg:col-span-6">
        {/*Header */}
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0">
          ...
          <h2 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">
            The DLCCFAM Ape Coding Club | NFT Drop
          </h2>
          <p className="pt-2 text-xl text-green-500">13 / 21 NFT'S cleaimed</p>
        </div>
        {/*min button */}
